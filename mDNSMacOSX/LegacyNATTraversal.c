 ...
 * 11/15/2018 NB-W Added support for a new PLATFORM_HAVE_INET_PTON #define because newer windows actually supports inet_pton directly.
 */
...
//NB-W newer Windows has inet_pton
#ifndef PLATFORM_HAVE_INET_PTON
static int
